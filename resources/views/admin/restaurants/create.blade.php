...
<div class="container overflow-auto p-5 d-flex flex-column align-items-center" style="max-height: calc(100vh - 70.24px);">
    ...
    <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" required min="10000000" max="99999999999" class="form-control @error('vat_number') is-invalid @enderror" id="vat_number" name="vat_number" placeholder="12345678901" value="{{ old('vat_number')}}">
        </div>
        @error('vat_number')
        <p class="text-danger">{{ $message }}</p>
        @enderror
