                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"        minlength="9" class="form-control @error('password') is-invalid @enderror" name="password"
                            ...
                            <div class="mb-4 row ">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" minlength="9" class="form-control"
                                        name="password_confirmation" required autocomplete="new-password">
                                </div>
                                <div class="d-flex justify-content-center">
                                    <span id="password-error" class="badge bg-danger mt-3 w-50 ">Le password non
                                        corispondono!</span>
                                </div>
                            </div>
