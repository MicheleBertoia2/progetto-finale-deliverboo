...
<template>
    ...
    <div class="container-inner">
        ...
        <div class="d-flex flex-wrap justify-content-evenly align-items-center position-relative slider-container">
